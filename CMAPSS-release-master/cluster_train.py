...
from dataset.preprocessing_cluster import *
...
train_cluster, train_labels_clustered, valid_cluster, valid_labels_clustered, test_cluster, test_labels_clustered,  test_cluster_last, test_labels_clustered_last,num_test_windows,  valid_cluster_indices, test_cluster_indices, test_last_cluster_indices = get_dataloader_1(
...
train_loaders = get_trainloader_2(train_cluster, train_labels_clustered)
...
def GPR_train(train_loader,model_lstm):
    ...
    kernel = C(1.0, (1e-8, 1e3)) * RationalQuadratic(length_scale=100.0, length_scale_bounds=(1e-1, 10)) # rq_  尝试-8(18.00)-5,-4(16.8),-3(16.76,16.25),-2(18.4)
