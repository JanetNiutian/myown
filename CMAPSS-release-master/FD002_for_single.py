...
def GPR_test(gpr,test_loader,engine_id):
    ...
    # plt.legend()
    plt.savefig(f'/home/niutian/原data/code/CMAPSS-release-master/single/FD002_{engine_id}_GPR.pdf')
    # plt.show()
...
if __name__ == '__main__':
    ...
    for i in range(1, 259):
        if i == 145 or i == 185:
            engine_id = i
            test_egine = get_test_engine(dir_path='/home/niutian/原data/code/CMAPSS-release-master/CMAPSSData/', sub_dataset='FD002', max_rul=125, seq_length=20, smooth_rate=128, engine_id=i)
