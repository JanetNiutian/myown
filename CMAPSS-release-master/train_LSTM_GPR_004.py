...
class LSTMModel(nn.Module):
    def __init__(self, input_size=14, hidden_layer_size=100, output_size=1, num_layers=3):
...
test_egine1 = get_test_engine(dir_path='/home/niutian/原data/code/CMAPSS-release-master/CMAPSSData/', sub_dataset='FD004', max_rul=125, seq_length=15, smooth_rate=128, engine_id=1)
...
def GPR_train(train_loader):
    ...
    indices = np.random.choice(total_samples, 15000, replace=False)
...
def GPR_test_average(test_loader):
    ...
    # plt.ylabel('RUL')
    # plt.legend()
    # plt.savefig('/data/niutian/code/CMAPSS-release-master/FD003_LSTM+GPR.png')
    # plt.show()
...
def GPR_test_last(test_loader): # 乱序last 
    ...
    plt.ylabel('RUL')
    plt.legend()
    plt.savefig('/home/niutian/原data/code/CMAPSS-release-master/FD004_last_20000.png')
    plt.plot(samples, gpr_predictions*125, 'b--', label='Predicted RUL')
    plt.savefig('/home/niutian/原data/code/CMAPSS-release-master/FD004_last_lines_20000.png')
