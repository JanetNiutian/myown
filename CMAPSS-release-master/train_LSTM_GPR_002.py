...
test_egine1 = get_test_engine(dir_path='/home/niutian/原data/code/CMAPSS-release-master/CMAPSSData/', sub_dataset='FD002', max_rul=125, seq_length=20, smooth_rate=128, engine_id=1)
...
def GPR_test_last(test_loader): # 乱序last 
    ...
    plt.ylabel('RUL')
    plt.legend()
    plt.savefig('/home/niutian/原data/code/CMAPSS-release-master/FD002_last_5500.png')
    plt.plot(samples, gpr_predictions*125, 'b--', label='Predicted RUL')
    plt.savefig('/home/niutian/原data/code/CMAPSS-release-master/FD002_last_lines_5500.png')
