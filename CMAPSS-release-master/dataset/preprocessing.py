...
def get_dataloader(dir_path, sub_dataset, max_rul, seq_length, batch_size,
    ...
    num_test_windows = []
    engine_id = 0
    test_engine_id = 1 # np.random.randint(1, 101)
    ...
    # f_save = open('/data/niutian/code/CMAPSS-release-master/FD004_train_x.pkl', 'wb')  #new
    # pickle.dump(train_array, f_save)
    # f_save = open('/data/niutian/code/CMAPSS-release-master/FD004_train_y.pkl', 'wb')  #new
    # pickle.dump(train_labels, f_save)
    ...
    # f_save = open('/data/niutian/code/CMAPSS-release-master/FD004_test_last_x.pkl', 'wb')  #new
    # pickle.dump(test_array_last, f_save)
    # f_save = open('/data/niutian/code/CMAPSS-release-master/FD004_test_last_y.pkl', 'wb')  #new
    # pickle.dump(test_labels_last, f_save)
