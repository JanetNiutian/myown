...
def get_dataloader(dir_path, sub_dataset, max_rul, seq_length, batch_size,
    ...
    # f_save = open('/data/niutian/code/CMAPSS-release-master/FD003_train_x.pkl', 'wb')  #new
    # pickle.dump(train_array, f_save)
    # f_save = open('/data/niutian/code/CMAPSS-release-master/FD003_train_y.pkl', 'wb')  #new
    ...
    # f_save = open('/data/niutian/code/CMAPSS-release-master/FD003_test_last_x.pkl', 'wb')  #new
    # pickle.dump(test_array_last, f_save)
    # f_save = open('/data/niutian/code/CMAPSS-release-master/FD003_test_last_y.pkl', 'wb')  #new
