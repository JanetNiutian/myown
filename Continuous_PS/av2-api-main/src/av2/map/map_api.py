...
class GroundHeightLayer(RasterMapLayer):
    ...
    @classmethod
    def from_file(cls, log_map_dirpath: Path) -> GroundHeightLayer: #Union[Path, UPath]
...
class ArgoverseStaticMap:
    ...
    @classmethod
    def from_json(cls, static_map_path: Path) -> ArgoverseStaticMap:#Union[Path, UPath]
    ...
    @classmethod
    def from_map_dir(
        cls, log_map_dirpath: Path, build_raster: bool = False #Union[Path, UPath]
    ) -> ArgoverseStaticMap:
