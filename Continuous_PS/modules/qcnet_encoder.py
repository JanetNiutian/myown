...
#from modules.qcnet_agent_encoder_wo_velocity import QCNetAgentEncoder
from modules.qcnet_map_encoder import QCNetMapEncoder


class QCNetEncoder(nn.Module): #需要继承nn.Module类，并重新实现构造函数__init__构造函数和forward这两个方法
    ...
    def __init__(self,
                 ...
                 num_heads: int,
                 head_dim: int,
                 dropout: float) -> None: #它是一个对函数的类型注解，简单表示方法什么都不返回
